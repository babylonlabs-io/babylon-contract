...
// https://github.com/babylonchain/babylon/blob/v0.5.0/x/epoching/types/keys.go
pub const EPOCHING_STORE_KEY: &[u8] = b"epoching";
// https://github.com/babylonchain/babylon/blob/v0.5.0/x/checkpointing/types/keys.go
pub const CHECKPOINTING_STORE_KEY: &[u8] = b"checkpointing";
// https://github.com/babylonchain/babylon/blob/v0.5.0/x/zoneconcierge/types/keys.go
pub const ZONECONCIERGE_STORE_KEY: &[u8] = b"zoneconcierge";

pub fn get_epoch_info_key(epoch_number: u64) -> Vec<u8> {
    // https://github.com/babylonchain/babylon-private/blob/ce3dc60d493c6c388282dcb1e64ccd2408c1bd43/x/epoching/types/keys.go#L22-L23
...
pub fn get_valset_key(epoch_number: u64) -> Vec<u8> {
    // https://github.com/babylonchain/babylon-private/blob/ce3dc60d493c6c388282dcb1e64ccd2408c1bd43/x/checkpointing/types/keys.go#L28-L29
...
pub fn get_cz_header_key(chain_id: &String, height: u64) -> Vec<u8> {
    // https://github.com/babylonchain/babylon-private/blob/ce3dc60d493c6c388282dcb1e64ccd2408c1bd43/x/zoneconcierge/types/keys.go#L33-L34
