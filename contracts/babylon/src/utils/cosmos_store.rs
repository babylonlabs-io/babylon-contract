...
// https://github.com/babylonchain/babylon/blob/v0.8.0-rc.0/x/epoching/types/keys.go
pub const EPOCHING_STORE_KEY: &[u8] = b"epoching";
// https://github.com/babylonchain/babylon/blob/v0.8.0-rc.0/x/checkpointing/types/keys.go
pub const CHECKPOINTING_STORE_KEY: &[u8] = b"checkpointing";
// https://github.com/babylonchain/babylon/blob/v0.8.0-rc.0/x/zoneconcierge/types/keys.go
pub const ZONECONCIERGE_STORE_KEY: &[u8] = b"zoneconcierge";

pub fn get_epoch_info_key(epoch_number: u64) -> Vec<u8> {
    // https://github.com/babylonchain/babylon/blob/8638c950fd2de1ac5dc69a8b9f710c1fa720c155/x/epoching/types/keys.go#L21
...
pub fn get_valset_key(epoch_number: u64) -> Vec<u8> {
    // https://github.com/babylonchain/babylon/blob/8638c950fd2de1ac5dc69a8b9f710c1fa720c155/x/checkpointing/types/keys.go#L28
...
pub fn get_cz_header_key(chain_id: &String, height: u64) -> Vec<u8> {
    // https://github.com/babylonchain/babylon/blob/8638c950fd2de1ac5dc69a8b9f710c1fa720c155/x/zoneconcierge/types/keys.go#L33
